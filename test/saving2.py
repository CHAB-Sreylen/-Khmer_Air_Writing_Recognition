...
def draw_point(image, landmark, color=(0, 0, 255), radius=5):
    h, w, _ = image.shape
...
def draw_center_box(image, overlay_img1, overlay_img2, khmer_text, font_khmer, text_position, text_color, color=(25, 167, 206), thickness=2):
    ...
    text_box_padding = 20  # Additional padding for the text box
    box_width, box_height = 480, 260
    text_box_height = 150
    ...
    if results.multi_hand_landmarks:
        ...
        if is_drawing_state(hand_landmarks):
            ...
            if not cleared and is_clearing_state(hand_landmarks):
                ...
                save_strokes_csv(strokes, 'train1.csv')  # Save strokes on saving gesture
                strokes.clear()  # Optionally clear after saving
            drawing = False
    # else:
    #     cleared = False 
